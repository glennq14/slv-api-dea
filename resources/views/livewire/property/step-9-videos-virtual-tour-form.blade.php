                ...
                <div class="w-full">
                    ...
                    <div class="">
                        <div class="p-4 sm:p-8 bg-gray-50 border-t border-gray-200">
                            <label for="embed_url_1" class="required-field block text-black text-sm mb-1">{{ __('YouTube Embedded Link 1:') }}</label>
                            <input type="text" 
                                    name="embed_url_1" 
                                    id="embed_url_1" 
                        ...
                        <div class="p-4 sm:p-8 bg-gray-50 border-t border-gray-200">
                            <label for="embed_url_2" class="required-field block text-black text-sm mb-1">{{ __('YouTube Embedded Link 2:') }}</label>
                            <input type="text" 
                                    name="embed_url_2" 
                                    id="embed_url_2" 
                                    class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="" required />
                        ...
                        <div class="p-4 sm:p-8 bg-gray-50 border-t border-gray-200">
                            <label for="virtual_tour_link" class="required-field block text-black text-sm mb-1 ">{{ __('Virtual Tour Link (Kuula etc.):') }}</label>
                            <input type="text" 
