<x-app-layout>
    ...
    <div class="p-4 sm:p-8 bg-white shadow-md sm:rounded-lg">
        <section>
            <h2 class="text-lg font-semibold">{{ __('Create Developer') }}</h2>
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 gap-5 mb-4 mt-3">
                <div>
                    ...
                    <input type="text" name="first_name" id="firstName" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required placeholder="Enter developer first name">
            ...
            <div class="grid grid-cols-3 md:grid-cols-3 gap-5 mb-4">
                <div>
                    ...
                    <input type="email" name="email" id="email" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required placeholder="Enter developer email address" >
                ...
                <div>
                    ...
                    <input type="text" name="phone_number" id="telephone" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Enter developer telephone number">
                </div>

                <div>
                    <label for="mobile" class=" block text-black text-sm mb-1">{{ __('Mobile') }}</label>
                    <input type="text"  name="mobile_number" id="mobile" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Enter developer mobile number">
                </div>
            </div>
            <div class="py-5 flex gap-3">
                <a href="{{ route('developer.index') }}" class="bg-gray-500 text-white px-4 py-3 rounded hover:bg-gray-600">
                    Cancel
                </a>
