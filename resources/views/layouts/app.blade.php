...
<div class="layout">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('developers') }}" class="nav-link {{ request()->routeIs('developers') ? 'active' : '' }}">
            ...
            <a href="{{ route('agents') }}" class="nav-link {{request()->routeIs('agents') ? 'active' : '' }}">
    ...
    <div class="main-area">
        <header class="header">
            ...
            <div class="header-right">
                ...
                <div class="user-menu" x-data="{ open: true }">
